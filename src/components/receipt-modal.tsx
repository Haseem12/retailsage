...
export default function ReceiptModal({ isOpen, onClose, items, subtotal }: ReceiptModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-sm font-mono text-sm">
        <DialogHeader className="text-center items-center">
          <Gem className="w-8 h-8 text-primary my-2"/>
          <DialogTitle className="font-headline text-lg">RetailSage</DialogTitle>
